...
export function TestimonialsSection() {
  return (
    <section id="testimonials" className="relative py-24 md:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#CEA53D]/30 to-transparent z-30" />
      <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#CEA53D]/10 to-transparent blur-sm z-30" />
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-[#0D0D0D]/70 via-[#0D0D0D]/80 to-[#0D0D0D]/95 mix-blend-multiply z-10" />
      ...
      <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-[#CEA53D]/6 rounded-full blur-[140px] z-10" />
      <div className="absolute bottom-1/3 right-1/4 w-[600px] h-[600px] bg-[#FFA500]/6 rounded-full blur-[140px] z-10" />

      {/* Decorative quote patterns */}
      <div className="absolute top-10 left-10 text-[#CEA53D]/5 z-10">
        <Quote className="w-32 h-32" strokeWidth={1} />
      </div>
      <div className="absolute bottom-10 right-10 text-[#CEA53D]/5 z-10 rotate-180">
        <Quote className="w-32 h-32" strokeWidth={1} />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="relative h-full bg-black/90 backdrop-blur-md border-2 border-[#CEA53D]/30 rounded-xl p-8 md:p-10 lg:p-12 hover:border-[#CEA53D] transition-all duration-500 overflow-hidden shadow-2xl hover:shadow-[0_0_60px_rgba(255,215,0,0.4)] flex flex-col hover:scale-[1.02]" style={{ boxShadow: '0 0 25px rgba(255, 215, 0, 0.2), inset 0 0 40px rgba(255, 215, 0, 0.05)' }}>

                {/* Large decorative quote - top left */}
                <div className="absolute -top-6 -left-6 text-[#CEA53D]/10 group-hover:text-[#CEA53D]/20 transition-colors duration-500">
                ...
                <div className="relative z-10 flex justify-end gap-1 mb-6">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-[#CEA53D] text-[#CEA53D] transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12" />
                  ))}
                </div>
                ...
                <div className="relative z-10 flex items-center gap-4 pt-6 border-t border-[#CEA53D]/30">
                  {/* Avatar with initials in gold frame */}
                  <div className="flex-shrink-0 relative">
                    <div className="relative w-16 h-16 md:w-20 md:h-20 rounded-sm bg-black border-4 border-[#CEA53D] flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform duration-500" style={{ boxShadow: '0 0 20px rgba(255, 215, 0, 0.6), inset 0 0 15px rgba(255, 215, 0, 0.2)' }}>
                      <span
                        className="text-[#CEA53D] font-black"
                        style={{
                          fontFamily: "'Bebas Neue', sans-serif",
                  ...
                  <div className="flex-grow">
                    ...
                    <p
                      className="text-[#CEA53D] text-sm uppercase tracking-wider font-semibold mb-1"
                ...
                {/* Hover glow overlay */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#CEA53D]/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-3xl" />
              </div>
            </motion.div>
          ))}
        </div>
